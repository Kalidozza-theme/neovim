...
function M.apply()
  ...
  vim.api.nvim_set_hl(0, "SnacksPickerTitle", { fg = p.color2, bold = true })
  ...
  vim.api.nvim_set_hl(0, "SnacksPickerPreviewTitle", { fg = p.color5, bold = true })
  vim.api.nvim_set_hl(0, "SnacksPickerList", { fg = p.fg1, bg = p.bg1 })
  vim.api.nvim_set_hl(0, "SnacksPickerListBorder", { fg = p.uic1, bg = p.bg1 })
  vim.api.nvim_set_hl(0, "SnacksPickerListTitle", { fg = p.color4, bold = true })
  ...
  vim.api.nvim_set_hl(0, "SnacksPickerInputSearch", { fg = p.color3 })
  vim.api.nvim_set_hl(0, "SnacksPickerBoxBorder", { fg = p.uic1, bg = p.bg1 })

  -- Notifier
  vim.api.nvim_set_hl(0, "SnacksNotifier", { fg = p.fg1, bg = p.bg2 })
  vim.api.nvim_set_hl(0, "SnacksNotifierBorder", { fg = p.uic1, bg = p.bg2 })
  ...
  vim.api.nvim_set_hl(0, "SnacksExplorerTitle", { fg = p.color2, bold = true })
  ...
  vim.api.nvim_set_hl(0, "SnacksExplorerGitIgnored", { fg = p.comment })

  -- Scroll
  vim.api.nvim_set_hl(0, "SnacksScroll", { fg = p.color6 })
